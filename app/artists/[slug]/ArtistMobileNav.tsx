...
export default function ArtistMobileNav({
  ...
  return (
    <nav
      className="mobile-bottom-nav fixed bottom-0 left-0 right-0 z-40 flex items-center justify-between bg-white px-4 py-4 lg:hidden border-t border-neutral-300"
