...
export default function FairMobileNav({
  ...
  return (
    <nav
      className="mobile-bottom-nav fixed bottom-0 left-0 right-0 z-40 flex items-center justify-between bg-white lg:hidden border-t border-neutral-300 px-4 py-2"
